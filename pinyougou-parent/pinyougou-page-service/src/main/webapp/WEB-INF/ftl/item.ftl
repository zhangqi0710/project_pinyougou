...
<body ng-app="pinyougou" ng-controller="itemController" ng-init="num=1;defaultSKU()">
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<a href="javascript:void(0)" class="increment plus" ng-click="addCollection(1)">+</a>
										<a href="javascript:void(0)" class="increment mins" ng-click="addCollection(-1)">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a ng-click="addGoodsToCart()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
